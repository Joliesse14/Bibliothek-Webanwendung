...
Im Rahmen der Bibliotheksanwendung lassen sich folgende Stakeholder identifizieren:
    \\- \textbf{Mitglieder} -- Nutzer der Bibliothek, die Bücher ausleihen, zurückgeben und ihren Kontostatus einsehen möchten. Sie interagieren über eine einfache Webanwendung mit dem System.
    ...
    \\- \textbf{Administratorinnen und Administratoren} -- Mitarbeitende mit erweiterten Rechten, die Statistiken einsehen, Bücher verwalten und Auswertungen nach Zeitraum, Autor oder Mitglied durchführen können.
...
%\textbf{Performance:}
%\begin{itemize}
 %   \item Das System soll mehrere gleichzeitige Nutzer unterstützen und unter Last stabil bleiben.
  %  \item Datenbankabfragen werden durch gezielte Joins und Begrenzungen optimiert.
%\end{itemize}

%\textbf{Benutzbarkeit:}
%\begin{itemize}
 %   \item Die Oberfläche ist für die Nutzung auf Smartphones optimiert, insbesondere die Buchsuche für Mitglieder.
  %  \item Die Barcode-Eingabe simuliert einen Scanner und kann auch über die Tastatur erfolgen.
   % \item Fehlermeldungen sind verständlich formuliert und werden direkt in der Benutzeroberfläche angezeigt.
%\end{itemize}
\begin{figure}[H]
  \centering
